...
import 'package:employeeappflutter/employeeAdd.dart';
import 'package:employeeappflutter/employees.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScopedModel<EmployeesModel>(
      model: model,
      child: MaterialApp(
        ...
        routes: {
          '/add_employee' : (context) => employeePage(),
